...
if __name__ == "__main__":
    ...
    print(f"Time taken for sequential execution: {seq_time:.4f} seconds")
    print(f"Time taken for multithreading execution: {mt_time:.4f} seconds")
    print(f"Time taken for multiprocessing execution: {mp_time:.4f} seconds")

    speedup_mt = seq_time / mt_time
    speedup_mp = seq_time / mp_time

    print(f"Speedup using multithreading: {speedup_mt:.2f}x")
    print(f"Speedup using multiprocessing: {speedup_mp:.2f}x")
    print("=" * 50)
